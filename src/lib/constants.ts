...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "Registration is $30 for a full weekend pass. Register online, or at the registration table in the lobby of the conference when you get here. Scholarships are available and no one is turned away for lack of funds. See the Registration page to reserve your seat or to ask about a scholarship, quietly.",
  },
  {
