...
const SHARE_TEXTS = [
  {
    platform: "General",
    text: `IAYPAA X is coming to Iowa City in August 2026! The theme is Primordial Ooze — a B-movie horror celebration of 10 years of IAYPAA. Don't miss it!`,
  },
  {
  ...
  },
  {
    ...
    text: `Have you heard about IAYPAA X? It's a young people in AA conference in Iowa City this August. Speakers, workshops, fellowship, and a wild Primordial Ooze theme. You should come!`,
  },
];
          ...
          <div className="flex justify-center gap-4">
            ...
            >
              ...
              <div className="text-left">
                <div className="font-[family-name:var(--font-creepster)] text-ember text-lg glow-text-subtle">
                  Instagram
                </div>
