  ...
  return (
    <div className="py-20 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Host the Hospitality Suite — home groups claim a meal/snack slot
            via SignUpGenius. The lineup below is static; live availability
            (who has claimed what) stays on SignUpGenius. */}
        <section id="hospitality-suite" className="mb-16 scroll-mt-24">
          <GlowText as="h2" glow="subtle" className="mb-4 text-center">
            Host the Hospitality Suite
          </GlowText>
          <p className="text-bone-white/70 text-center mb-10 max-w-2xl mx-auto">
            The hospitality suite at the Highlander is the social hub of the
            weekend — and it runs on home groups. Each slot below is a meal or
            snack shift one group hosts together: bring the food, serve the
            fellowship, and keep the room warm. Claim your group&apos;s slot on
            SignUpGenius.
          </p>
